...
function appendToolTips(){
	$("#plotList li").prop("title","This is a plot selector. Clicking on it will load the plot's spectral time series data and the corresponding image chips.");
	...
	d3.selectAll("circle.data").select("title").text("This is an annual spectral time series point. It is the mean spectral return for the pixels in the plot for the composite window selected to represent this year in the annual time series. Hovering over it will activate a green highlight outline that corresponds to the green highlight outline of the matched image chip in the chip gallery. The highlighting feature makes it easy to know which point belongs to which image chip. Doubling clicking the point will toggle it as a vertex. The first and last points cannot be toggled.");
	...
	$("#chipGallerySection").prop("title","This is the annual image chip gallery. It holds the time series of image chips. The chips in the gallery will repopulate each time you click on a plot from the plot list. Use the scroll bar on the bottom to view image chips that are off the screen, and use the 'Chip Set' selector at the middle of the interface to change the chip index to your preference.");
